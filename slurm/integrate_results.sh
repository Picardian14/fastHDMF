...
#SBATCH --time=1:00:00
#SBATCH --mem=64G
#SBATCH --chdir=/network/iss/home/ivan.mindlin/Repos/VirtualFingerprint/
...
singularity exec $SINGULARITY_IMAGE bash -c "source /opt/anaconda/3/2023.07-2/base/etc/profile.d/conda.sh && conda activate fic && python3 src/modeling/HDMF/src/integrate_distributed_results.py $EXPERIMENT_ID"
