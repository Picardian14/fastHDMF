...
#SBATCH --job-name=AAL_NVC_stat_fcd
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=64G
#SBATCH --cpus-per-task=24
#SBATCH --chdir=/network/iss/home/ivan.mindlin/Repos/fastHDMF/matlab
#SBATCH --output=../slurm/outputs/AAL_NVC_stat_fcd.out
#SBATCH --error=../slurm/errors/AAL_NVC_stat_fcd.err
...
sub_experiment_name = "AAL_NVC_stat_fcd";
% Load Data
